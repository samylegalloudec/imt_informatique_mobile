 ...
 */
const UneAction = (props) => (
  <View style={styles.conteneurUneAction}>
    <Text style={styles.texteUneAction} onPress={props.onSupprimerAction}>
      {props.action.actionText}
    </Text>
    <View style={styles.boutons}>
      <BoutonAction nom={"Terminer"} onPress={props.onTerminer} />
      <BoutonAction nom={"Supprimer"} onPress={props.onSupprimer} />
    </View>
  </View>
);
